# This busybox recipe was backported from yocto sumo branch.
# This had to be done because petalinux is using an old busybox version (1.24) which has no support
# for mdev lookup under /sys/bus which is obviously a problem for iio devices.
require busybox.inc
